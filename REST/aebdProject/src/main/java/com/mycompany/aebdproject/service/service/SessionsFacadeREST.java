...
import com.mycompany.aebdproject.service.Sessions;
 ...
 */
@Stateless
@Path("com.mycompany.aebdproject.service.sessions")
public class SessionsFacadeREST extends AbstractFacade<Sessions> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") BigDecimal id, Sessions entity) {
        super.edit(entity);
    }
    ...
    public Sessions find(@PathParam("id") BigDecimal id) {
